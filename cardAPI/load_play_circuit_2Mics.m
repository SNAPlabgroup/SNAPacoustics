...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [f1,RP,FS]=load_play_circuit_2Mics(FS_tag,fig_num,GB_ch)
...
CIR_PATH='C:\Experiments\cardAPI\BasicPlay_ButtonIn_2Mics.rcx'; %The *.rco circuit used to play the files
