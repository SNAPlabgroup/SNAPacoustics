...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [f1,RP,FS]=load_play_circuit_Pitt(FS_tag,fig_num,USB_ch)
...
CIR_PATH='C:\Experiments\SNAPacoustics\cardAPI\BasicPlay_ButtonIn_OAE2.rcx'; %The *.rco circuit used to play the files
